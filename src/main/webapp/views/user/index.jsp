...
.col-6 {
    ...
    max-width: 100%; /* Đảm bảo phần tử không vượt quá 100% chiều rộng */
    margin-right: auto; /* Đẩy phần tử ra bên trái */
    margin-left: 0; /* Đảm bảo không có khoảng trống bên trái */
}
